...
const ProjectDetails = () => {
  ...
  const filteredTasks = (() => {
    ...
    return tasksToFilter.slice().sort((a, b) => {
  ...
  useEffect(() => {
    console.log("Raw tasks:", currentProject?.tasks);
    console.log("Filtered tasks:", filteredTasks);
  }, [currentProject, selected, sortBy]);
                ...
                <div class="modal-body">
                  <form onSubmit={handleAddTask}>
                    ...
                    <div class="mb-3">
                      ...
                      >
                        {[
                          ...new Set(taskData?.flatMap((task) => task.tags)),
                        ].map((tag) => (
                    ...
                    <div class="mb-3">
                      ...
                      >
                        {[...new Set(taskData?.map((task) => task.status))].map(
                          (status) => (
